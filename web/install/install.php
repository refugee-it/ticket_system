        ...
        if (Database::Get()->IsConnected() === true)
        {
            ...
            */
            ...
            if ($success === true)
            {
                if ($dropExistingTables === true)
                {
                    if (Database::Get()->ExecuteUnsecure("DROP TABLE IF EXISTS `".Database::Get()->GetPrefix()."tickets`") !== true)
                    {
                        $success = false;
                    }
                }
            ...
            if ($success === true)
            {
                ...
                $sql .= "`".Database::Get()->GetPrefix()."tickets` (".
                        ...
                        "  `creator_e_mail` varchar(255) COLLATE utf8_bin NOT NULL,".
            ...
            if ($success === true)
            {
                if ($dropExistingTables === true)
                {
                    if (Database::Get()->ExecuteUnsecure("DROP TABLE IF EXISTS `".Database::Get()->GetPrefix()."uploaded_images`") !== true)
                    {
                        $success = false;
                    }
                }
            ...
            if ($success === true)
            {
                ...
                $sql .= "`".Database::Get()->GetPrefix()."uploaded_images` (".
                        "  `id` int(11) NOT NULL AUTO_INCREMENT,".
